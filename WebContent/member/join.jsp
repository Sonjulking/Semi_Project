...
<body>
	...
	<div class="container1">
		...
		</span> <br> <br> <span class="text1">겜만추에서 수 많은 사람들과 플레이하고,</span>
	...
	<div
		...
		<form method="post" enctype="multipart/form-data"
			...
			<span>프로필 사진 : </span> <input type="file" name="profile_img"
				...
				class="input-wd" name="id" size="20" placeholder="아이디 / 영문 + 숫자">
			<p id="id_check"></p>
			<br> <label class="name " for="name">NickName</label><br> <input
				type="text" id="name" class="input-wd" name="name"
				placeholder="닉네임 입력"> <span id="name_check"></span> <br>
			<br> <label class="password" for="password1">PWD</label><br>
			<input type="password" id="password1" class="inputpwd input-wd"
				name="pwd" placeholder="비밀번호 / 6~12자">
			<p id="pwd_check"></p>
			<label class="password" for="password2">PWD2</label><br> <input
				type="password" class="inputpwd input-wd" id="password2"
				class="inputpwd" name="pwd_recheck" placeholder="비밀번호 / 6~12자"><br>
			<p id="pwd_recheck"></p>
			...
			<br> <label class="email" for="email">Email</label><br> <input
				type="text" id="email" class="input-wd" name="email"
				placeholder="Email"><span id="email_check"></span> <br>
			<label class="phone" for="phone">Phone</label><br> <input
				type="text" id="phone" class="input-wd" name="phone"
				placeholder="전화번호"> <br> <br>

			<div style="font-size: 15pt; text-align: center;">

				<label class="game-title">선호 게임</label> <br> <label for="lol"
					class="game1"><input type="checkbox" name="lol" value="lol">&nbsp;LOL</label>
				&nbsp; <label class="game2" for="battle_ground"><input
					type="checkbox" name="battle_ground" value="battle_ground">&nbsp;Battleground</label>
				<label for="overwatch" class="game3"> &nbsp;&nbsp;<input
			...
			<div style="text-align: center;">
				<label class="check_join"><input type="checkbox"
					...
					동의</label> <br>
				<button id="signup-btn" class="signup submit-btn nes-btn is-success"
					type="submit" name="join" onclick="">회원가입</button>
			</div>
		</form>
	</div>
