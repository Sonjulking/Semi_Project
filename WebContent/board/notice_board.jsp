...
<body>
	...
	<div align="center">
		...
		<form method="post" action="<%=request.getContextPath() %>/board_search.do?type=notice">
		...
		<nav>
			<ul class="pagination">
				<li class="page-item"><a class="page-link"
					href="${check }page=1&type=notice">First</a></li>
			 <c:if test="${page != 1 }">
				<li><a class="page-link" href="${check }page=${page -1}&type=notice">Previous</a>
				</li>
		     </c:if>
				...
				<c:forEach begin="${startBlock }" end="${endBlock }" var="i">
					<c:if test="${i == page }">
						<li class="page-item active" aria-current="page"><a
							class="page-link" href="${check }page=${i }&type=notice">${i }</a></li>
					</c:if>
				  ...
				  <c:if test="${page != allPage }">
					<li class="page-item"><a class="page-link"
						href="${check }page=${page + 1 }&type=notice">Next</a></li>
				</c:if>

					<li class="page-item"><a class="page-link"
						href="${check }page=${allPage }&type=notice">End</a></li>
			</ul>
		</nav>
	</div>
